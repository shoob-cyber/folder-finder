...
export const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="text-4xl sm:text-5xl lg:text-6xl font-black font-mono text-[#2dd4a8] tracking-tight mb-2 drop-shadow-[0_0_15px_rgba(0,212,255,0.4)] group-hover:drop-shadow-[0_0_25px_rgba(0,212,255,0.7)] transition-all duration-300">
        {displayValue}
      </div>
