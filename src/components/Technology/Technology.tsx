...
export const Technology: React.FC = () => {
  ...
  return (
    <section
      id="technology"
      className="relative w-full bg-[#0a0e27] py-24 sm:py-32 overflow-hidden tech-grid-subtle border-t border-[#1a2847]"
      aria-label="Technology Stack Section"
    >
      {/* Glow Orbs */}
      <div className="absolute top-1/3 -right-32 w-96 h-96 bg-[#00d4ff]/10 rounded-full blur-[130px] pointer-events-none" />
      <div className="absolute bottom-10 -left-32 w-96 h-96 bg-[#9d4edd]/10 rounded-full blur-[130px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col justify-start">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#1a2847]/80 border border-[#00d4ff]/30 text-[#00d4ff] text-xs font-mono font-bold tracking-wider uppercase mb-4 w-fit"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-[#888899] leading-relaxed mb-8"
            >
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
              <div className="flex items-center gap-3 p-3.5 rounded-xl bg-[#0f153a]/80 border border-[#1a2847]">
                <ShieldCheck className="w-5 h-5 text-[#00d4ff] shrink-0" />
                <div className="flex flex-col">
                  <span className="text-xs font-bold text-white">HIPAA Compliant</span>
                  <span className="text-[10px] font-mono text-[#888899]">Signed BAA Protocol</span>
                </div>
              </div>

              <div className="flex items-center gap-3 p-3.5 rounded-xl bg-[#0f153a]/80 border border-[#1a2847]">
                <Lock className="w-5 h-5 text-[#9d4edd] shrink-0" />
                <div className="flex flex-col">
                  <span className="text-xs font-bold text-white">SOC 2 Type II</span>
                  <span className="text-[10px] font-mono text-[#888899]">Annual Audit Certified</span>
                </div>
              </div>

              <div className="flex items-center gap-3 p-3.5 rounded-xl bg-[#0f153a]/80 border border-[#1a2847]">
                <FileCheck className="w-5 h-5 text-[#ff6b35] shrink-0" />
                <div className="flex flex-col">
                  <span className="text-xs font-bold text-white">FDA 21 CFR Part 11</span>
                  <span className="text-[10px] font-mono text-[#888899]">Audit Trail Integrity</span>
                </div>
              </div>

              <div className="flex items-center gap-3 p-3.5 rounded-xl bg-[#0f153a]/80 border border-[#1a2847]">
                <Server className="w-5 h-5 text-[#00d4ff] shrink-0" />
                <div className="flex flex-col">
                  <span className="text-xs font-bold text-white">ISO 27001</span>
                  <span className="text-[10px] font-mono text-[#888899]">Global Cloud Enclaves</span>
                </div>
              </div>
            </div>

            {/* Live Interactive Spec Card based on Selected Tech */}
            <div className="p-5 rounded-xl bg-[#0f153a]/90 border border-[#00d4ff]/30 shadow-[0_0_25px_rgba(0,212,255,0.15)] relative overflow-hidden">
              <div className="flex items-center justify-between border-b border-[#1a2847] pb-3 mb-3">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs font-mono">
                <div>
                  <span className="text-[#888899] block text-[10px]">ARCHITECTURE</span>
                  <span className="text-white font-medium">{activeTech.details.architecture}</span>
                </div>
                <div>
                  <span className="text-[#888899] block text-[10px]">LATENCY BENCHMARK</span>
                  <span className="text-[#00d4ff] font-bold">{activeTech.details.latency}</span>
                </div>
                <div>
                  <span className="text-[#888899] block text-[10px]">INTEGRATION PROTOCOL</span>
                  <span className="text-white font-medium">{activeTech.details.integration}</span>
                </div>
                <div>
                  <span className="text-[#888899] block text-[10px]">SECURITY ENCLAVE</span>
                  <span className="text-[#9d4edd] font-semibold">{activeTech.details.security}</span>
                </div>
              </div>
            </div>
          </div>
