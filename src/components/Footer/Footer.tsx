...
export const Footer: React.FC = () => {
  return (
    <footer
      className="relative w-full bg-[#070a1e] border-t border-[#1a2847] pt-16 pb-12 overflow-hidden text-white"
      role="contentinfo"
      aria-label="Footer"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 pb-12 border-b border-[#1a2847]/70">
          {/* Brand Col */}
          <div className="lg:col-span-2 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-[#00d4ff]/15 border border-[#00d4ff]/40 text-[#00d4ff]">
              ...
              <p className="text-sm text-[#888899] max-w-sm leading-relaxed mb-6">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#0f153a] border border-[#1a2847] w-fit text-xs font-mono text-white/80">
          ...
          {/* Links Col 1 */}
          <div>
            <h4 className="font-mono text-xs font-bold uppercase tracking-wider text-[#00d4ff] mb-4">
              Platform
            </h4>
            <ul className="space-y-2.5 text-sm text-[#888899]">
        ...
        {/* Bottom bar */}
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#888899]">
