  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {/* Description */}
        <p className="text-sm sm:text-base text-[#9bb0a7] group-hover:text-[#d7e6df] leading-relaxed mb-6 transition-colors duration-200">
          {description}
        </p>
      </div>
        ...
        {interactiveType === "slider" && (
          <div className="flex flex-col gap-2">
            <div className="flex justify-between text-xs font-mono">
              ...
              <span className="font-bold text-[#ffffff]">{(sliderVal * 0.001).toFixed(3)} µm</span>
            </div>
            <input
              type="range"
              min="20"
